...
public class ArrayListLinkedList {
	...
	public static void main(String[] args) {
		...
		// 데이터 삽입/삭제 는 LinkedList 가 ArrayList 보다 빠르다
		...
		if( arrayListTime > linkedListTime) {
			System.out.println("LinkedList 가 데이터 삽입 속도가 더 빠릅니다.");
		}else {
			System.out.println("ArrayList 가 데이터 삽입 속도가 더 빠릅니다.");
		}
	}
