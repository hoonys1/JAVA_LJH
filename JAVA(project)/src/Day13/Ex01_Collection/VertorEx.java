...
public class VertorEx {
	...
	public static void main(String[] args) {
		...
		// 개수,용량 확인
		System.out.println("개수 : " + vector.size());		// 개수는 현재 넣어둔 요소 수
		System.out.println("용량 : " + vector.capacity());	// 용량은 위에 정해둔 수	Vector<String> vector = new Vector<String>(10);
		System.out.println();
